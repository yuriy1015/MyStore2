...
namespace MyStore.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        //[HttpPost]
        //public async Task<IActionResult> ProductsManagement(bool showAll, string section, string category, string colorName)
        //{
        //    ProductsManagementBindingModel bindingModel = new();
        //    var bindingModelOptions = await _iODatabase.GetOptionNames();
        ...
        //    bindingModel.OptionColorList = bindingModelOptions.OptionColorList;
        //    bindingModel.ColoredProductsList = bindingModelProducts.ColoredProductsList;
        //    bindingModel.SelectedShowAll = showAll;
